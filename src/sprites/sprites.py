...
class Blinky(Ghost):
    def __init__(self, pos: tuple[int, int], sprite: Path,
        ...
        super().__init__(pos, True, 1, True, False,
                         sprite, (255, 0, 0), (17, -2), tile_size)
...
class Pinky(Ghost):
    def __init__(self, pos: tuple[int, int], sprite: Path,
                 tile_size: int = 24) -> None:
        super().__init__(pos, True, 1, True, False,
                         sprite, (255, 184, 255), (1, -2), tile_size)
...
class Clyde(Ghost):
    def __init__(self, pos: tuple[int, int], sprite: Path,
                 tile_size: int = 32) -> None:
        super().__init__(pos, True, 1, True, False,
                         sprite, (255, 184, 82), (0, 22), tile_size)
